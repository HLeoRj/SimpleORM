...
type
  [Tabela('PRODUTO')]
  [ProceName('PRODUTO_IU_RESULT')]
  [ProceSel('PRODUTO_SEL')]
  [ProceDel('PRODUTO_DEL')]
  TPRODUTO = class
  private
    FGUUID :String;
    FCODIGO :String;
  ...
  public
    ...
    function Limpar: TPRODUTO;
    [Campo('GUUID'), PK,ResultProc('RESULTGUUID')]
...
function TPRODUTO.Limpar : TPRODUTO;
begin
  result := self;
  Self.GUUID := '';
  Self.CODIGO := '';
