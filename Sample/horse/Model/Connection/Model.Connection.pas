...
begin
  ...
  FConnList.Items[Result].Params.Database := '/3051:C:\Delphi Files\Componentes - DXE10_Tokio\SimpleRepo\Sample\Database\PDVUPDATES.FDB';
  FConnList.Items[Result].Params.UserName := 'SYSDBA';
  FConnList.Items[Result].Params.Password := 'a236512';
