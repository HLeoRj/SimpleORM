...
type
  ...
  public
    ...
    function FieldResult : string;
    function EhResulName: Boolean;
    function EhFieldImput: Boolean;
    function FieldImput: string;
  end;
...
function TRttiTypeHelper.IsProceName: Boolean;
begin
  Result := Tem<ProceName>
end;

function TRttiPropertyHelper.EhResulName: Boolean;
begin
  Result := Tem<ResultProc>
end;

function TRttiPropertyHelper.FieldResult: string;
begin
  Result := Name;
  if EhResulName then
    Result := GetAttribute<ResultProc>.Name;
end;

function TRttiPropertyHelper.FieldImput: string;
begin
  Result := Name;
  if EhFieldImput then
    Result := GetAttribute<ProcImput>.Name;
end;

function TRttiPropertyHelper.EhFieldImput: Boolean;
begin
  Result := Tem<ProcImput>
end;
